...
DAG-Nodes: TSK-P3-WP-AI-GOV; TSK-P3-SUPPORT-DOC-001
...
work package `TSK-P3-WP-AI-GOV`. It refines the Wave 5 broad plan into
the concrete planning obligations for:

- `TSK-P3-WP-AI-GOV` — the work package that produces the AI governance
...
|---|---|---|
| `TSK-P3-WP-AI-GOV` | `AI_ASSISTED_ESTIMATION_AND_DECISION_SUPPORT_DOCTRINE.md`; `UNCERTAINTY_AND_ESTIMATION_SEMANTICS_DOCTRINE.md` | AI governance must remain constitutional namespace, schema, and admissibility gate definition only; no execution surfaces may be introduced |
...
The following must exist and be canonical before `TSK-P3-WP-AI-GOV`
...
- `TSK-P3-WP-AI-GOV` becomes runnable after `TSK-P3-WP-013` is complete
