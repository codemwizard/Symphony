...
- Hardening Wave-6 immutability follow-up (`0070_hard_wave6_reference_policy_post_deactivation_immutability.sql`) blocks post-rotation policy tampering by enforcing protected-field immutability after ACTIVE→INACTIVE transitions while retaining legal status rotation semantics.
