...
| INV-124 | P1 | Regulatory timing compliance gate is deterministic and evidence-backed per rail policy | ["team-platform", "team-invariants"] | scripts/perf/verify_perf_005.sh --evidence evidence/phase1/perf_005__regulatory_timing_compliance_gate.json; evidence/phase1/perf_005__regulatory_timing_compliance_gate.json |
