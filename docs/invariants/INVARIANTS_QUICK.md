...
| INV-113 | P0 | Hybrid anchor-sync schema hooks present (Phase-0 structural readiness) | ["team-db", "team-platform"] | scripts/db/verify_anchor_sync_hooks.sh; evidence/phase0/anchor_sync_hooks.json |
