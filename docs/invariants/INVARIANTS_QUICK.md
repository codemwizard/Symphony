...
| INV-111 | P0 | BoZ observability role exists + provably read-only (DB structural) | ["team-db", "team-platform"] | scripts/db/verify_boz_observability_role.sh; evidence/phase0/boz_observability_role.json |
| INV-112 | P0 | ZDPA PII leakage prevention lint (fail-closed on regulated payload surfaces) | ["team-security", "team-platform"] | scripts/audit/lint_pii_leakage_payloads.sh; evidence/phase0/pii_leakage_payloads.json |
| INV-113 | P0 | Hybrid anchor-sync schema hooks present (Phase-0 structural readiness) | ["team-db", "team-platform"] | scripts/db/verify_anchor_sync_hooks.sh; scripts/db/verify_anchor_sync_operational_invariant.sh; scripts/db/tests/test_anchor_sync_operational.sh; evidence/phase0/anchor_sync_hooks.json; evidence/phase1/anchor_sync_operational_invariant.json; evidence/phase1/anchor_sync_resume_semantics.json |
| INV-114 | P0 | Payment finality / instruction irrevocability (reversal-only via ISO 20022 camt.056) | ["team-db", "team-platform"] | scripts/db/verify_instruction_finality_invariant.sh; scripts/db/tests/test_instruction_finality.sh; evidence/phase1/instruction_finality_invariant.json |
| INV-115 | P0 | PII decoupling + right-to-be-forgotten survivability (evidence remains valid after PII purge) | ["team-security", "team-db", "team-platform"] | scripts/db/verify_pii_decoupling_hooks.sh; scripts/db/tests/test_pii_decoupling.sh; evidence/phase1/pii_decoupling_invariant.json |
| INV-116 | P0 | Rail truth-anchor sequence continuity (generic; jurisdiction profiles e.g. ZM-NFS) | ["team-db", "team-platform"] | scripts/db/verify_rail_sequence_truth_anchor.sh; scripts/db/tests/test_rail_sequence_continuity.sh; evidence/phase1/rail_sequence_truth_anchor.json |
| INV-117 | P0 | DB timeout posture is bounded and fail-closed (lock/statement/idle-in-tx) | ["team-db", "team-platform"] | scripts/db/verify_timeout_posture.sh; evidence/phase0/db_timeout_posture.json |
| INV-118 | P0 | Ingress hot-path index posture is mechanically verified (tenant/instruction/correlation paths) | ["team-db", "team-platform"] | scripts/db/tests/test_ingress_hotpath_indexes.sh; evidence/phase1/ingress_hotpath_indexes.json |
| INV-119 | P1 | Agent-governed regulated-surface change control requires conformance + approval trace integrity | ["team-security", "team-invariants"] | scripts/audit/verify_agent_conformance.sh; wired via scripts/dev/pre_ci.sh (pre-gates) and Phase-1 governance gate (INT-G28) |
| INV-120 | P1 | Perf promotion is fail-closed and evidence-backed before perf-stage execution | ["team-platform", "team-invariants"] | scripts/audit/verify_p1_057_final_perf_promotion.sh; evidence/phase1/p1_057_final_perf_promotion.json |
| INV-121 | P1 | Engine metrics capture is non-invasive and contract-required for perf governance | ["team-platform", "team-invariants"] | scripts/audit/verify_perf_001_engine_metrics_capture.sh; evidence/phase1/perf_001_engine_metrics_capture.json |
| INV-122 | P1 | Perf regression classification and mandatory warmup are baseline-driven and enforced | ["team-platform", "team-invariants"] | scripts/audit/verify_perf_002_regression_detection_warmup.sh; evidence/phase1/perf_002_regression_detection_warmup.json |
| INV-123 | P1 | Perf baseline promotion requires SHA-locked approval | ["team-platform", "team-invariants"] | scripts/audit/verify_perf_003_rebaseline_sha_lock.sh; evidence/phase1/perf_003_rebaseline_sha_lock.json |
| INV-124 | P1 | Regulatory timing compliance gate is deterministic and evidence-backed per rail policy | ["team-platform", "team-invariants"] | scripts/audit/verify_perf_004_regulatory_timing_compliance_gate.sh; evidence/phase1/perf_004__regulatory_timing_compliance_gate.json |
| INV-125 | P1 | Finality seam stub is wired for compliance computation without claiming live rail finality | ["team-platform", "team-invariants"] | scripts/audit/verify_perf_005a_finality_seam_stub.sh; evidence/phase1/perf_005a_finality_seam_stub.json |
| INV-126 | P1 | Closeout KPI evidence includes settlement window compliance and PERF-005 linkage | ["team-platform", "team-invariants"] | scripts/perf/verify_perf_006.sh --evidence evidence/phase1/perf_006__operational_risk_framework_translation_layer.json; evidence/phase1/perf_006__operational_risk_framework_translation_layer.json |
...
| INV-137 | P1 | Control plane cannot mutate data plane outside approved seams | ["team-db", "team-security", "team-platform"] | scripts/db/verify_plane_isolation.sh; evidence/phase1/plane_isolation.json |
| INV-138 | P1 | Authority transition binding enforces policy decision reference and execution ID equality | ["team-platform", "team-invariants"] | scripts/db/verify_authority_transition_binding.sh; evidence/phase2/tsk_p2_preauth_004_03.json |
| INV-142 | P1 | Identity provenance is immutable once verified | ["team-security", "team-platform"] | scripts/audit/verify_identity_provenance_immutability.sh; evidence/phase1/identity_provenance_immutability.json |
| INV-143 | P1 | Audit records precede external side-effects | ["team-platform", "team-security"] | scripts/audit/verify_audit_precedence.sh; evidence/phase1/audit_precedence.json |
| INV-144 | P1 | Raw card data is absent from schemas, logs, and traces | ["team-security", "team-platform"] | scripts/security/verify_card_data_non_presence.sh; evidence/phase1/card_data_non_presence.json |
| INV-146 | P1 | Acknowledged commands require durable attestation and outbox lineage | ["team-db", "team-platform"] | scripts/db/verify_attestation_outbox_atomicity.sh; evidence/command_integrity/cmd_001_attestation_outbox_atomicity.json |
| INV-147 | P1 | Command lifecycle states and dispatch eligibility remain deterministic | ["team-db", "team-platform"] | scripts/db/verify_command_lifecycle_integrity.sh; evidence/command_integrity/cmd_002_command_lifecycle_integrity.json |
| INV-148 | P1 | Command and query logic are structurally separated | ["team-architecture", "team-platform"] | scripts/audit/verify_cqrs_code_boundary.sh; evidence/phase1/cqrs_001_code_separation.json |
| INV-149 | P1 | Command-side and query-side database roles are isolated | ["team-db", "team-security", "team-platform"] | scripts/db/verify_command_query_role_separation.sh; evidence/phase1/cqrs_002_db_role_separation.json |
| INV-150 | P1 | Initial projection set is deterministic, rebuildable, and freshness-aware | ["team-platform", "team-architecture"] | scripts/db/verify_projection_freshness_and_scope.sh; evidence/phase1/proj_001_initial_projection_set.json |
| INV-151 | P1 | Externally consumed read APIs are projection-backed | ["team-platform", "team-security"] | scripts/audit/verify_no_hot_table_external_reads.sh; evidence/phase1/proj_002_external_query_cutover.json |
| INV-152 | P1 | Projection cutover completeness is one-shot and legacy references are removed | ["team-platform", "team-invariants"] | scripts/audit/verify_cut_001_one_shot_projection_cutover.sh; evidence/phase1/cut_001_one_shot_projection_cutover.json |
| INV-153 | P1 | Post-cutover query surfaces remain handler-mediated and trust-bounded | ["team-platform", "team-security"] | scripts/audit/verify_cut_002_query_surface_boundary.sh; evidence/phase1/cut_002_query_surface_boundary.json |
| INV-154 | P1 | Projection cutover runbook defines deterministic stop and rollback discipline | ["team-platform", "team-invariants"] | scripts/audit/verify_cut_003_projection_cutover_runbook.sh; evidence/phase1/cut_003_projection_cutover_runbook.json |
| INV-155 | P1 | Projection cutover promotion is gated by aggregated prerequisite proof | ["team-platform", "team-invariants"] | scripts/audit/verify_cut_004_projection_cutover_gate.sh; evidence/phase1/cut_004_projection_cutover_gate.json |
