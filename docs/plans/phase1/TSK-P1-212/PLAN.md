...
## objective
Repair the DB-backed ingress store and make db_psql the canonical hardened demo mode.
...
## remediation_trace
failure_signature: PHASE1.P1.212.DB_PSQL_CANONICAL
repro_command: see task verifier commands in meta.yml
verification_commands_run: []
final_status: planned
origin_task_id: TSK-P1-212
origin_gate_id: PHASE1.P1.212.DB_PSQL_CANONICAL
