...
## Mission
Pilot AuthN AuthZ and Tenant Boundary Enforcement.

## Scope
In scope:
- Deliver task outputs defined in `tasks/TSK-P1-022/meta.yml`.
...
## Acceptance
- Acceptance criteria in `tasks/TSK-P1-022/meta.yml` are met.
