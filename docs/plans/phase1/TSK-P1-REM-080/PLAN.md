# TSK-P1-REM-080 PLAN — Halt Auto-Generated Governance Exceptions (The Bypass Loop)

Task: TSK-P1-REM-080
Owner: SECURITY_GUARDIAN
failure_signature: PHASE1.STRICT.TSK-P1-REM-080.PROOF_FAIL
...
Halt Auto-Generated Governance Exceptions (The Bypass Loop). This task forms a closed proof graph from work items to acceptance criteria to execution trace.
...
| File | Action | Reason |
|------|--------|--------|
| `scripts/audit/verify_strict_invariant_linkage.sh` | CREATE | Verifier for this task |
| `evidence/phase1/tsk_p1_rem_080.json` | CREATE | Output artifact |
| `tasks/TSK-P1-REM-080/meta.yml` | MODIFY | Update status upon success |
| `docs/plans/phase1/TSK-P1-REM-080/EXEC_LOG.md` | MODIFY | Append completion data |
...
**How:**
- [ID tsk_p1_rem_080_01] Disable the automated generation of EXC-* bypass files in the CI pipeline.
**Done when:** All items are implemented.

### Step 2: Implement Verifier
**What:** Build the strictly mapped verifier script.
**How:**
- Implement `scripts/audit/verify_strict_invariant_linkage.sh`.
...
**How:**
```bash
bash scripts/audit/verify_strict_invariant_linkage.sh > evidence/phase1/tsk_p1_rem_080.json
```
...
bash scripts/audit/verify_strict_invariant_linkage.sh
