...
## objective
Split key domains, eliminate key reuse, and support managed rotation through OpenBao-backed secrets.
...
## remediation_trace
failure_signature: PHASE1.P1.216.KEY_DOMAIN_SEPARATION
repro_command: see task verifier commands in meta.yml
verification_commands_run: []
final_status: planned
origin_task_id: TSK-P1-216
origin_gate_id: PHASE1.P1.216.KEY_DOMAIN_SEPARATION
