...
## objective
Move onboarding control-plane state into governed persisted storage and replace env-driven tenant/programme onboarding.

## implementation_boundaries
- 217 owns tenant registry + programme lifecycle + policy binding + activation state.
- 217 must not recreate supplier/allowlist persistence. (Handled by 214).
...
## remediation_trace
failure_signature: PHASE1.P1.217.CONTROL_PLANE_PERSISTENCE
repro_command: see task verifier commands in meta.yml
verification_commands_run: []
final_status: planned
origin_task_id: TSK-P1-217
origin_gate_id: PHASE1.P1.217.CONTROL_PLANE_PERSISTENCE
