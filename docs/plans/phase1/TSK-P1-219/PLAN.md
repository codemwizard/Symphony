...
## objective
Deliver an operator onboarding console in the website using server-side auth boundaries rather than raw admin API key handling in the browser.
...
## remediation_trace
failure_signature: PHASE1.P1.219.OPERATOR_ONBOARDING_UI
repro_command: see task verifier commands in meta.yml
verification_commands_run: []
final_status: planned
origin_task_id: TSK-P1-219
origin_gate_id: PHASE1.P1.219.OPERATOR_ONBOARDING_UI
