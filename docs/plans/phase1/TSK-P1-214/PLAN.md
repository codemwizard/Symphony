...
## objective
Persist supplier registry and programme allowlist state in PostgreSQL as the hardened source of truth.

## implementation_boundaries
- 214 owns supplier registry + programme supplier allowlist persistence.
- 214 must not absorb tenant/programme control-plane ownership. (Handled by 217).
...
## remediation_trace
failure_signature: PHASE1.P1.214.SUPPLIER_POLICY_PERSISTENCE
repro_command: see task verifier commands in meta.yml
verification_commands_run: []
final_status: planned
origin_task_id: TSK-P1-214
origin_gate_id: PHASE1.P1.214.SUPPLIER_POLICY_PERSISTENCE
