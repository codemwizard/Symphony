...
| 5     | GF-W1-SCH-001 | Migration 0080: adapter_registrations | 0080_gf_adapter_registrations.sql + sidecar |
...
| 5     | GF-W1-SCH-006 | regulatory plane + jurisdictions    | 0102-0103 |
| 6     | GF-W1-SCH-007 | schema closeout verifier wiring     | CI wiring only |
| 7     | GF-W1-SCH-008 | verifier_registry + Reg 26 constraint | 0106 |
...
| 2     | GF-W1-FNC-001 | register_project, activate_project  | 0105 |
...
| 2     | GF-W1-FNC-007 | confidence enforcement + issuance gate | 0104 |
| 3     | GF-W1-FNC-005 | issue_asset_batch, retire_asset_batch | 0084 |
| 4     | GF-W1-PLT-001 | Register PWRM0001 adapter           | ZERO migrations |

**⚠️ WARNING:** FNC-007 (migration 0104) must complete before FNC-005 (migration 0084). DAG order, not numeric order.
...
- SCH-006: 0102-0103 (regulatory plane + jurisdictions) [CORRECTED: 0078-0079 already applied]
- SCH-007: CI wiring only (Phase-0 schema closeout verifier wiring)
- SCH-008: 0106 (verifier_registry) [CORRECTED: 0087 was before 0097 causing forward-reference; renumbered to 0106]
- FNC-001: 0105 (register/activate_project) [CORRECTED: 0080 is owned by SCH-001/adapter_registrations; renumbered to 0105 (after FNC-007 at 0104)]
...
- FNC-007: 0104 (confidence enforcement + issuance gate) [CORRECTED: 0087 owned by SCH-008]
