...
- Linked remediation trace casefile for post-deactivation reference-policy immutability follow-up (`0070_hard_wave6_reference_policy_post_deactivation_immutability.sql`).
