# TSK-P2-PREAUTH-005-04 PLAN — Implement enforce_transition_authority() trigger

Task: TSK-P2-PREAUTH-005-04
Owner: DB_FOUNDATION
Depends on: TSK-P2-PREAUTH-005-03
failure_signature: PRE-PHASE2.PREAUTH.TSK-P2-PREAUTH-005-04.TRIGGER_FAIL
...
### Step 1: Add enforce_transition_authority() function to migration 0120
**What:** `[ID tsk_p2_preauth_005_04_work_item_01]` Add enforce_transition_authority() function to migration 0120
**How:** Modify schema/migrations/0120_create_state_transitions.sql to add function as SECURITY DEFINER with SET search_path = pg_catalog, public. Function verifies policy_decision_id is present for authoritative transitions and raises GF033 if missing
**Done when:** Migration file contains enforce_transition_authority() function definition

### Step 2: Attach function as BEFORE INSERT OR UPDATE trigger on state_transitions
**What:** `[ID tsk_p2_preauth_005_04_work_item_02]` Attach function as trigger
...
**What:** `[ID tsk_p2_preauth_005_04_work_item_03]` Create verify_tsk_p2_preauth_005_04.sh
...
**Done when:** Verification script exists at scripts/db/verify_tsk_p2_preauth_005_04.sh
...
**What:** `[ID tsk_p2_preauth_005_04_work_item_04]` Implement the negative test for enforce_transition_authority() trigger
**How:** Define execution failure test (TSK-P2-PREAUTH-005-04-N1) that simulates missing function or incorrect SECURITY DEFINER setting. Feed bad schema state into the verification logic and ensure it is explicitly rejected.
...
**What:** `[ID tsk_p2_preauth_005_04_work_item_05]` Execute verification script
**How:** Run: bash scripts/db/verify_tsk_p2_preauth_005_04.sh
**Done when:** Script exits 0 and emits evidence to evidence/phase2/tsk_p2_preauth_005_04.json

## Verification

```bash
# [ID tsk_p2_preauth_005_04_work_item_01] [ID tsk_p2_preauth_005_04_work_item_02]
# [ID tsk_p2_preauth_005_04_work_item_03] [ID tsk_p2_preauth_005_04_work_item_04] [ID tsk_p2_preauth_005_04_work_item_05]
...
# [ID tsk_p2_preauth_005_04_work_item_05]
...
- No verification that policy_decision_id values actually reference valid policy decisions (presence check only)
