# TSK-P2-W5-REM-01 PLAN — Implement Cross-Entity-Replay Protection via Expand/Contract

Task: TSK-P2-W5-REM-01
Owner: DB_FOUNDATION
failure_signature: PHASE2.STRICT.TSK-P2-W5-REM-01.PROOF_FAIL
...
Implement Cross-Entity-Replay Protection via Expand/Contract. This task forms a closed proof graph from work items to acceptance criteria to execution trace.
...
| File | Action | Reason |
|------|--------|--------|
| `scripts/audit/verify_tsk_p2_w5_rem_01.sh` | CREATE | Verifier for this task |
| `evidence/phase2/tsk_p2_w5_rem_01.json` | CREATE | Output artifact |
| `tasks/TSK-P2-W5-REM-01/meta.yml` | MODIFY | Update status upon success |
| `docs/plans/phase2/TSK-P2-W5-REM-01/EXEC_LOG.md` | MODIFY | Append completion data |
...
**How:**
- [ID tsk_p2_w5_rem_01_01] Expand migration: ADD COLUMN entity_type TEXT and entity_id UUID (nullable) to execution_records.
- [ID tsk_p2_w5_rem_01_02] Backfill migration: Populate entity_type/entity_id from FK-bound policy_decisions.
- [ID tsk_p2_w5_rem_01_03] Constrain migration: ALTER COLUMN SET NOT NULL for both columns after backfill.
- [ID tsk_p2_w5_rem_01_04] Insert-time coherence trigger: Create enforce_policy_decisions_entity_coherence trigger to validate matching IDs.
**Done when:** All items are implemented.

### Step 2: Implement Verifier
**What:** Build the strictly mapped verifier script.
**How:**
- Implement `scripts/audit/verify_tsk_p2_w5_rem_01.sh`.
...
**How:**
```bash
bash scripts/audit/verify_tsk_p2_w5_rem_01.sh > evidence/phase2/tsk_p2_w5_rem_01.json
```
...
bash scripts/audit/verify_tsk_p2_w5_rem_01.sh
