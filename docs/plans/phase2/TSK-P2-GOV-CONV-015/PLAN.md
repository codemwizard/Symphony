# TSK-P2-GOV-CONV-015 PLAN — Wire claim-admissibility verifier into local/CI gates

Task: TSK-P2-GOV-CONV-015
...
Wire claim-admissibility verifier into local/CI gates. This task forms a closed proof graph from work items to acceptance criteria to execution trace.
...
| File | Action | Reason |
|------|--------|--------|
| `scripts/audit/verify_gov_conv_015.sh` | CREATE | Verifier for this task |
| `evidence/phase2/gov_conv_015_ci_wiring.json` | CREATE | Output artifact |
| `tasks/TSK-P2-GOV-CONV-015/meta.yml` | MODIFY | Update status upon success |
| `docs/plans/phase2/TSK-P2-GOV-CONV-015/EXEC_LOG.md` | MODIFY | Append completion data |
...
**How:**
- [ID gov_conv_015_w01] Add verify_phase_claim_admissibility.sh call to scripts/dev/pre_ci.sh
- [ID gov_conv_015_w02] Add claim-admissibility check to .github/workflows/ci.yml workflow
- [ID gov_conv_015_w03] Ensure evidence path is wired into CI expectations
- [ID gov_conv_015_w04] Test that CI fails when claim-admissibility violations exist
**Done when:** All items are implemented.

### Step 2: Implement Verifier
**What:** Build the strictly mapped verifier script.
**How:**
- Implement `scripts/audit/verify_gov_conv_015.sh`.
...
bash scripts/audit/verify_gov_conv_015.sh
