# TSK-P2-GOV-CONV-020 PLAN — Verify Phase-4 stub non-claimability only

Task: TSK-P2-GOV-CONV-020
...
Verify Phase-4 stub non-claimability only. This task forms a closed proof graph from work items to acceptance criteria to execution trace.
...
| File | Action | Reason |
|------|--------|--------|
| `scripts/audit/verify_gov_conv_020.sh` | CREATE | Verifier for this task |
| `evidence/phase2/gov_conv_020_phase4_verification.json` | CREATE | Output artifact |
| `tasks/TSK-P2-GOV-CONV-020/meta.yml` | MODIFY | Update status upon success |
| `docs/plans/phase2/TSK-P2-GOV-CONV-020/EXEC_LOG.md` | MODIFY | Append completion data |
...
**How:**
- [ID gov_conv_020_w01] Create verifier that checks Phase-4 stub non-claimability status
- [ID gov_conv_020_w02] Verify README.md contains explicit non-open language
- [ID gov_conv_020_w03] Verify phase4_contract.yml has zero implementation rows
- [ID gov_conv_020_w04] Ensure verifier rejects any premature Phase-4 opening artifacts
**Done when:** All items are implemented.

### Step 2: Implement Verifier
**What:** Build the strictly mapped verifier script.
**How:**
- Implement `scripts/audit/verify_gov_conv_020.sh`.
...
bash scripts/audit/verify_gov_conv_020.sh
