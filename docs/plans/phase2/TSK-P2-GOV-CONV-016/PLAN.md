# TSK-P2-GOV-CONV-016 PLAN — Report admissibility violations, read-only

Task: TSK-P2-GOV-CONV-016
...
Report admissibility violations, read-only. This task forms a closed proof graph from work items to acceptance criteria to execution trace.
...
| File | Action | Reason |
|------|--------|--------|
| `scripts/audit/verify_gov_conv_016.sh` | CREATE | Verifier for this task |
| `evidence/phase2/gov_conv_016_violation_report.json` | CREATE | Output artifact |
| `tasks/TSK-P2-GOV-CONV-016/meta.yml` | MODIFY | Update status upon success |
| `docs/plans/phase2/TSK-P2-GOV-CONV-016/EXEC_LOG.md` | MODIFY | Append completion data |
...
**How:**
- [ID gov_conv_016_w01] Create read-only verifier that scans claim-admissibility evidence
- [ID gov_conv_016_w02] Generate violation report with task IDs and violation types
- [ID gov_conv_016_w03] Emit structured evidence of all detected violations
- [ID gov_conv_016_w04] Do not modify any task metadata - report only
**Done when:** All items are implemented.

### Step 2: Implement Verifier
**What:** Build the strictly mapped verifier script.
**How:**
- Implement `scripts/audit/verify_gov_conv_016.sh`.
...
bash scripts/audit/verify_gov_conv_016.sh
