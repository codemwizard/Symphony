# TSK-P2-SEC-002-00 PLAN — Create PLAN.md and verify alignment for INV-131
...
Task: TSK-P2-SEC-002-00
Owner: SECURITY_GUARDIAN
Depends on: None
failure_signature: PRE-PHASE2.SEC.INV131-PLAN.MISSING
canonical_reference: docs/operations/AI_AGENT_OPERATION_MANUAL.md

---

## Objective
Create the PLAN.md for INV-131 promotion. The plan will document the INV-131 promotion requirements including grep -E 'HTTPServer\s*\(\s*["\x27]127\.0\.0\.1["\x27]'. This task eliminates the risk of incomplete or incorrect implementation by providing architectural documentation and verification trace before implementation begins.
...
| File | Action | Reason |
|------|--------|--------|
| `docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md` | MODIFY | This file (populate with content) |
| `tasks/TSK-P2-SEC-002-00/meta.yml` | MODIFY | Update status to completed |
...
**What:** `[ID tsk_p2_sec_002_00_work_item_01]` Create PLAN.md at docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md from PLAN_TEMPLATE.md with all required sections.
...
### Step 2: Document INV-131 promotion requirements
**What:** `[ID tsk_p2_sec_002_00_work_item_02]` Document the INV-131 promotion requirements including grep -E 'HTTPServer\s*\(\s*["\x27]127\.0\.0\.1["\x27]'.
**How:** Add the grep pattern to the implementation steps section.
**Done when:** PLAN.md documents the grep -E 'HTTPServer\s*\(\s*["\x27]127\.0\.0\.1["\x27]'.

### Step 3: Run verify_plan_semantic_alignment.py
**What:** `[ID tsk_p2_sec_002_00_work_item_03]` Run verify_plan_semantic_alignment.py to validate proof graph integrity.
**How:** Run python3 scripts/audit/verify_plan_semantic_alignment.py --plan docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md --meta tasks/TSK-P2-SEC-002-00/meta.yml
...
```bash
test -f docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md || exit 1

grep -q "grep" docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md || exit 1

python3 scripts/audit/verify_plan_semantic_alignment.py --plan docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md --meta tasks/TSK-P2-SEC-002-00/meta.yml || exit 1
```

---

## Evidence Contract
File: `evidence/phase2/tsk_p2_sec_002_00.json`

Required fields:
- `task_id`: "TSK-P2-SEC-002-00"
...
- `plan_path`: "docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md"
...
1. Delete docs/plans/phase2/TSK-P2-SEC-002-00/PLAN.md
