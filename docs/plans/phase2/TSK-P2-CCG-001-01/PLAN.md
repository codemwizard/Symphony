# TSK-P2-CCG-001-01 PLAN — gate and promote INV-159/160/161/166
...
## Objective
gate and promote INV-159/160/161/166. This task ensures that the core contract gate is properly enforced and that INV-159/160/161/166 are promoted to implemented status. This task eliminates the risk of unverified contract gates being promoted without proper testing.

---

## Architectural Context
This task depends on TSK-P2-CCG-001-00 and cannot start until all security invariant promotions are complete. This guards against the anti-pattern of promoting contract gates without verified security invariants. The task provides the actual implementation and verification of the core contract gate.

---

## Pre-conditions
- [ ] TSK-P2-CCG-001-00 are status=completed and evidence validates
...
| `tasks/TSK-P2-CCG-001-01/meta.yml` | MODIFY | Update status to completed |
...
**What:** `[ID tsk_p2_ccg_001_01_work_item_01]` Create verifier script for core contract gate.
...
**What:** `[ID tsk_p2_ccg_001_01_work_item_02]` Run verifier to confirm core contract gate is properly enforced.
...
**What:** `[ID tsk_p2_ccg_001_01_work_item_03]` Promote INV-159/160/161/166 to implemented status in INVARIANTS_MANIFEST.yml.
...
```bash
# [ID tsk_p2_ccg_001_01_work_item_01]
test -x scripts/audit/verify_tsk_p2_ccg_CCG_001.sh || exit 1

# [ID tsk_p2_ccg_001_01_work_item_02]
bash scripts/audit/verify_tsk_p2_ccg_CCG_001.sh || exit 1

# [ID tsk_p2_ccg_001_01_work_item_03]
...
## Evidence Contract
File: `evidence/phase2/tsk_p2_ccg_001_01.json`
