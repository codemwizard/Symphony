...
## scope
- Add forward-only migration for `public.levy_rates` structural hook.
- Add fail-closed verifier `scripts/db/verify_levy_rates_hook.sh`.
- Wire verifier into `scripts/dev/pre_ci.sh`.
