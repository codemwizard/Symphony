    ...
    CONSTRAINT wave8_signer_active_period CHECK (((is_active = false) OR ((valid_from IS NOT NULL) AND ((valid_until IS NULL) OR (valid_until > now()))))),
