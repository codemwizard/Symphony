...
\restrict 6eaZYBCLg4OIQRHzEqtMUrO3c6dbG6aDIjS1C3udH3daijYCit6cwtZvELSuvry
...
--
-- Name: construct_canonical_attestation_payload(uuid, text, uuid, text, text, uuid, uuid, uuid, text, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.construct_canonical_attestation_payload(p_project_id uuid, p_entity_type text, p_entity_id uuid, p_from_state text, p_to_state text, p_execution_id uuid, p_interpretation_version_id uuid, p_policy_decision_id uuid, p_transition_hash text, p_occurred_at timestamp with time zone) RETURNS bytea
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $_$
DECLARE
...
--
-- Name: enforce_policy_decisions_entity_coherence(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enforce_policy_decisions_entity_coherence() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
--
-- Name: enforce_transition_hash_match(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enforce_transition_hash_match() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
--
-- Name: recompute_transition_hash(bytea); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.recompute_transition_hash(p_canonical_payload_bytes bytea) RETURNS text
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
--
-- Name: resolve_authoritative_signer(text, text, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.resolve_authoritative_signer(p_key_id text, p_key_version text, p_project_id uuid, p_entity_type text DEFAULT NULL::text) RETURNS TABLE(signer_id uuid, public_key_bytes bytea, scope text, is_authorized boolean, is_active boolean, valid_from timestamp with time zone, valid_until timestamp with time zone, superseded_by uuid, superseded_at timestamp with time zone, entity_type text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
--
-- Name: wave8_asset_batches_dispatcher(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.wave8_asset_batches_dispatcher() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
--
-- Name: wave8_cryptographic_enforcement(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.wave8_cryptographic_enforcement() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
--
-- Name: wave8_enforce_signer_active_period(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.wave8_enforce_signer_active_period() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
--
-- Name: wave8_reject_placeholders(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.wave8_reject_placeholders() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
CREATE TABLE public._migration_fingerprints (
...
--
-- Name: _migration_fn_hashes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public._migration_fn_hashes (
    migration_key text NOT NULL,
...
--
-- Name: _migration_guards; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public._migration_guards (
    key text NOT NULL,
    applied_at timestamp with time zone DEFAULT now() NOT NULL,
    skip_guard boolean DEFAULT false NOT NULL,
    force_override boolean DEFAULT false NOT NULL
);


--
-- Name: _preserved_policies; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public._preserved_policies (
...
--
-- Name: _rls_table_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public._rls_table_config (
    table_name text NOT NULL,
    ...
    CONSTRAINT _rls_table_config_isolation_type_check CHECK ((isolation_type = ANY (ARRAY['DIRECT'::text, 'JOIN'::text, 'GLOBAL'::text, 'JURISDICTION'::text])))
);
...
CREATE TABLE public.asset_batches (
    ...
    CONSTRAINT wave8_signature_required CHECK (((signature_bytes IS NOT NULL) AND (signer_key_id IS NOT NULL) AND (signer_key_version IS NOT NULL)))
);
...
ALTER TABLE ONLY public.escrow_summary_projection FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.evidence_bundle_projection FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.incident_case_projection FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.instruction_status_projection FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.internal_ledger_journals FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.internal_ledger_postings FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.program_member_summary_projection FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.regulatory_incidents FORCE ROW LEVEL SECURITY;
...
CREATE TABLE public.state_transitions (
    ...
    interpretation_version_id uuid NOT NULL,
    CONSTRAINT no_non_reproducible_data_authority CHECK (((data_authority IS NULL) OR (data_authority <> 'non_reproducible'::public.data_authority_level))),
    CONSTRAINT no_placeholder_transition_hash CHECK (((transition_hash IS NULL) OR (transition_hash !~~ 'PLACEHOLDER_%'::text)))
);
...
--
-- Name: wave8_attestation_nonces; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.wave8_attestation_nonces (
    nonce text NOT NULL,
...
--
-- Name: wave8_signer_resolution; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.wave8_signer_resolution (
    signer_id uuid DEFAULT gen_random_uuid() NOT NULL,
    key_id text NOT NULL,
    key_version text NOT NULL,
    ...
    CONSTRAINT wave8_signer_scope_not_null CHECK (((scope IS NOT NULL) AND (scope <> ''::text)))
);
...
--
-- Name: _migration_fingerprints _migration_fingerprints_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._migration_fingerprints
    ADD CONSTRAINT _migration_fingerprints_pkey PRIMARY KEY (migration_key, fingerprint_type);


--
-- Name: _migration_fn_hashes _migration_fn_hashes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._migration_fn_hashes
    ADD CONSTRAINT _migration_fn_hashes_pkey PRIMARY KEY (migration_key, function_name);


--
-- Name: _migration_guards _migration_guards_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._migration_guards
    ADD CONSTRAINT _migration_guards_pkey PRIMARY KEY (key);


--
-- Name: _preserved_policies _preserved_policies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._preserved_policies
    ADD CONSTRAINT _preserved_policies_pkey PRIMARY KEY (table_name, policy_name);


--
-- Name: _rls_table_config _rls_table_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._rls_table_config
    ADD CONSTRAINT _rls_table_config_pkey PRIMARY KEY (table_name);
...
--
-- Name: wave8_attestation_nonces wave8_attestation_nonces_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wave8_attestation_nonces
    ADD CONSTRAINT wave8_attestation_nonces_pkey PRIMARY KEY (nonce);


--
-- Name: wave8_signer_resolution wave8_signer_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wave8_signer_resolution
    ADD CONSTRAINT wave8_signer_key_unique UNIQUE (key_id, key_version);


--
-- Name: wave8_signer_resolution wave8_signer_resolution_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wave8_signer_resolution
    ADD CONSTRAINT wave8_signer_resolution_pkey PRIMARY KEY (signer_id);
...
--
-- Name: idx_execution_records_entity_coherence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_execution_records_entity_coherence ON public.execution_records USING btree (entity_type, entity_id);
...
--
-- Name: idx_wave8_signer_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wave8_signer_lookup ON public.wave8_signer_resolution USING btree (key_id, key_version) WHERE (is_active = true);


--
-- Name: idx_wave8_signer_project; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wave8_signer_project ON public.wave8_signer_resolution USING btree (project_id, entity_type) WHERE (is_active = true);
...
CREATE TRIGGER enforce_policy_decisions_entity_coherence BEFORE INSERT ON public.policy_decisions FOR EACH ROW EXECUTE FUNCTION public.enforce_policy_decisions_entity_coherence();
...
--
-- Name: asset_batches trg_enforce_transition_hash_match; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_enforce_transition_hash_match BEFORE INSERT OR UPDATE ON public.asset_batches FOR EACH ROW EXECUTE FUNCTION public.enforce_transition_hash_match();
...
--
-- Name: asset_batches trg_wave8_asset_batches_dispatcher; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_wave8_asset_batches_dispatcher BEFORE INSERT ON public.asset_batches FOR EACH ROW EXECUTE FUNCTION public.wave8_asset_batches_dispatcher();


--
-- Name: asset_batches trg_wave8_cryptographic_enforcement; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_wave8_cryptographic_enforcement BEFORE INSERT ON public.asset_batches FOR EACH ROW EXECUTE FUNCTION public.wave8_cryptographic_enforcement();


--
-- Name: asset_batches trg_wave8_reject_placeholders; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_wave8_reject_placeholders BEFORE INSERT ON public.asset_batches FOR EACH ROW EXECUTE FUNCTION public.wave8_reject_placeholders();


--
-- Name: wave8_signer_resolution trg_wave8_signer_active_period; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_wave8_signer_active_period BEFORE INSERT OR UPDATE ON public.wave8_signer_resolution FOR EACH ROW EXECUTE FUNCTION public.wave8_enforce_signer_active_period();
...
--
-- Name: wave8_attestation_nonces wave8_attestation_nonces_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: escrow_summary_projection; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.escrow_summary_projection ENABLE ROW LEVEL SECURITY;

--
-- Name: evidence_bundle_projection; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.evidence_bundle_projection ENABLE ROW LEVEL SECURITY;
...
--
-- Name: incident_case_projection; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.incident_case_projection ENABLE ROW LEVEL SECURITY;
...
--
-- Name: instruction_status_projection; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.instruction_status_projection ENABLE ROW LEVEL SECURITY;

--
-- Name: internal_ledger_journals; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.internal_ledger_journals ENABLE ROW LEVEL SECURITY;

--
-- Name: internal_ledger_postings; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.internal_ledger_postings ENABLE ROW LEVEL SECURITY;
...
--
-- Name: program_member_summary_projection; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.program_member_summary_projection ENABLE ROW LEVEL SECURITY;
...
--
-- Name: regulatory_incidents; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: adapter_registrations rls_base_adapter_registrations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_adapter_registrations ON public.adapter_registrations USING (true);


--
-- Name: billing_usage_events rls_base_billing_usage_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_billing_usage_events ON public.billing_usage_events USING (true);


--
-- Name: escrow_accounts rls_base_escrow_accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_escrow_accounts ON public.escrow_accounts USING (true);


--
-- Name: escrow_envelopes rls_base_escrow_envelopes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_escrow_envelopes ON public.escrow_envelopes USING (true);


--
-- Name: escrow_events rls_base_escrow_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_escrow_events ON public.escrow_events USING (true);


--
-- Name: escrow_reservations rls_base_escrow_reservations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_escrow_reservations ON public.escrow_reservations USING (true);


--
-- Name: escrow_summary_projection rls_base_escrow_summary_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_escrow_summary_projection ON public.escrow_summary_projection USING (true);


--
-- Name: evidence_bundle_projection rls_base_evidence_bundle_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_evidence_bundle_projection ON public.evidence_bundle_projection USING (true);


--
-- Name: external_proofs rls_base_external_proofs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_external_proofs ON public.external_proofs USING (true);


--
-- Name: incident_case_projection rls_base_incident_case_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_incident_case_projection ON public.incident_case_projection USING (true);


--
-- Name: instruction_status_projection rls_base_instruction_status_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_instruction_status_projection ON public.instruction_status_projection USING (true);


--
-- Name: internal_ledger_journals rls_base_internal_ledger_journals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_internal_ledger_journals ON public.internal_ledger_journals USING (true);


--
-- Name: internal_ledger_postings rls_base_internal_ledger_postings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_internal_ledger_postings ON public.internal_ledger_postings USING (true);


--
-- Name: member_device_events rls_base_member_device_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_member_device_events ON public.member_device_events USING (true);


--
-- Name: member_devices rls_base_member_devices; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_member_devices ON public.member_devices USING (true);


--
-- Name: members rls_base_members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_members ON public.members USING (true);


--
-- Name: payment_outbox_attempts rls_base_payment_outbox_attempts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_payment_outbox_attempts ON public.payment_outbox_attempts USING (true);


--
-- Name: payment_outbox_pending rls_base_payment_outbox_pending; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_payment_outbox_pending ON public.payment_outbox_pending USING (true);


--
-- Name: persons rls_base_persons; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_persons ON public.persons USING (true);


--
-- Name: program_member_summary_projection rls_base_program_member_summary_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_program_member_summary_projection ON public.program_member_summary_projection USING (true);


--
-- Name: program_migration_events rls_base_program_migration_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_program_migration_events ON public.program_migration_events USING (true);


--
-- Name: program_supplier_allowlist rls_base_program_supplier_allowlist; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_program_supplier_allowlist ON public.program_supplier_allowlist USING (true);


--
-- Name: programme_policy_binding rls_base_programme_policy_binding; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_programme_policy_binding ON public.programme_policy_binding USING (true);


--
-- Name: programme_registry rls_base_programme_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_programme_registry ON public.programme_registry USING (true);


--
-- Name: programs rls_base_programs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_programs ON public.programs USING (true);


--
-- Name: regulatory_incidents rls_base_regulatory_incidents; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_regulatory_incidents ON public.regulatory_incidents USING (true);


--
-- Name: sim_swap_alerts rls_base_sim_swap_alerts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_sim_swap_alerts ON public.sim_swap_alerts USING (true);


--
-- Name: supplier_registry rls_base_supplier_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_supplier_registry ON public.supplier_registry USING (true);


--
-- Name: tenant_clients rls_base_tenant_clients; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_tenant_clients ON public.tenant_clients USING (true);


--
-- Name: tenant_members rls_base_tenant_members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_tenant_members ON public.tenant_members USING (true);


--
-- Name: tenant_registry rls_base_tenant_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_tenant_registry ON public.tenant_registry USING (true);


--
-- Name: tenants rls_base_tenants; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_base_tenants ON public.tenants USING (true);


--
-- Name: adapter_registrations rls_iso_adapter_registrations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_adapter_registrations ON public.adapter_registrations AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: billing_usage_events rls_iso_billing_usage_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_billing_usage_events ON public.billing_usage_events AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: escrow_accounts rls_iso_escrow_accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_escrow_accounts ON public.escrow_accounts AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: escrow_envelopes rls_iso_escrow_envelopes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_escrow_envelopes ON public.escrow_envelopes AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: escrow_events rls_iso_escrow_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_escrow_events ON public.escrow_events AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: escrow_reservations rls_iso_escrow_reservations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_escrow_reservations ON public.escrow_reservations AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: escrow_summary_projection rls_iso_escrow_summary_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_escrow_summary_projection ON public.escrow_summary_projection AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: evidence_bundle_projection rls_iso_evidence_bundle_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_evidence_bundle_projection ON public.evidence_bundle_projection AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: external_proofs rls_iso_external_proofs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_external_proofs ON public.external_proofs AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: incident_case_projection rls_iso_incident_case_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_incident_case_projection ON public.incident_case_projection AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: instruction_status_projection rls_iso_instruction_status_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_instruction_status_projection ON public.instruction_status_projection AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: internal_ledger_journals rls_iso_internal_ledger_journals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_internal_ledger_journals ON public.internal_ledger_journals AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: internal_ledger_postings rls_iso_internal_ledger_postings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_internal_ledger_postings ON public.internal_ledger_postings AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: member_device_events rls_iso_member_device_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_member_device_events ON public.member_device_events AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: member_devices rls_iso_member_devices; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_member_devices ON public.member_devices AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: members rls_iso_members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_members ON public.members AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: payment_outbox_attempts rls_iso_payment_outbox_attempts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_payment_outbox_attempts ON public.payment_outbox_attempts AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: payment_outbox_pending rls_iso_payment_outbox_pending; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_payment_outbox_pending ON public.payment_outbox_pending AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: persons rls_iso_persons; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_persons ON public.persons AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: program_member_summary_projection rls_iso_program_member_summary_projection; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_program_member_summary_projection ON public.program_member_summary_projection AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: program_migration_events rls_iso_program_migration_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_program_migration_events ON public.program_migration_events AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: program_supplier_allowlist rls_iso_program_supplier_allowlist; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_program_supplier_allowlist ON public.program_supplier_allowlist AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: programme_policy_binding rls_iso_programme_policy_binding; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_programme_policy_binding ON public.programme_policy_binding AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: programme_registry rls_iso_programme_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_programme_registry ON public.programme_registry AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: programs rls_iso_programs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_programs ON public.programs AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: regulatory_incidents rls_iso_regulatory_incidents; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_regulatory_incidents ON public.regulatory_incidents AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: sim_swap_alerts rls_iso_sim_swap_alerts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_sim_swap_alerts ON public.sim_swap_alerts AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: supplier_registry rls_iso_supplier_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_supplier_registry ON public.supplier_registry AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: tenant_clients rls_iso_tenant_clients; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_tenant_clients ON public.tenant_clients AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: tenant_members rls_iso_tenant_members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_tenant_members ON public.tenant_members AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: tenant_registry rls_iso_tenant_registry; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_tenant_registry ON public.tenant_registry AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));


--
-- Name: tenants rls_iso_tenants; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rls_iso_tenants ON public.tenants AS RESTRICTIVE USING ((tenant_id = public.current_tenant_id_or_null())) WITH CHECK ((tenant_id = public.current_tenant_id_or_null()));
...
\unrestrict 6eaZYBCLg4OIQRHzEqtMUrO3c6dbG6aDIjS1C3udH3daijYCit6cwtZvELSuvry
