-- 0056_hier_009_instruction_hierarchy_sqlstate_alignment.sql
-- TSK-P1-HIER-009: align verify_instruction_hierarchy() SQLSTATE mapping.
...
COMMENT ON FUNCTION public.verify_instruction_hierarchy(TEXT, UUID, TEXT, UUID, UUID, UUID, TEXT) IS
  'Phase-1 hierarchy guard with deterministic SQLSTATE mapping P7299-P7303 for declared link failures.';
