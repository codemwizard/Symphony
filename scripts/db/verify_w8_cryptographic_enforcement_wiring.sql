...
-- Check 8: Test valid signature acceptance (physical write test)
DO $$
DECLARE
    test_result text;
    test_signer_id uuid;
...
BEGIN
    -- Insert test signer with valid key
    test_project_id := gen_random_uuid();
    INSERT INTO public.wave8_signer_resolution (
        key_id,
        key_version,
    ...
    -- Attempt to insert with valid signature format (64 bytes)
    BEGIN
        INSERT INTO public.asset_batches (
            asset_batch_id,
            tenant_id,
            ...
            'test_authority'::data_authority_level,
            false,
            'Valid signature test - should succeed - expected success',
            decode('', 'hex'),
            'c9a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3',
            decode('deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef', 'hex'), -- Valid: 64 bytes
            'test_valid_key_006',
            '1'
        ) RETURNING asset_batch_id INTO test_asset_batch_id;
        test_result := 'VALID_SIGNATURE_ACCEPTED';
    EXCEPTION WHEN OTHERS THEN
        test_result := 'VALID_SIGNATURE_REJECTED';
    END;
    
    RAISE NOTICE 'Valid signature acceptance test result: %', test_result;
...
-- Expected: VALID_SIGNATURE_ACCEPTED
